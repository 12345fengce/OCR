...
def load_tf_model():
    # load config file
    cfg.TEST.checkpoints_path = 'F:/Chinese-ocr/chinese_ocr/ctpn/checkpoints'
...
if __name__ == '__main__':
    ...
    cfg_from_file('F:/Chinese-ocr/chinese_ocr/ctpn/ctpn/text.yml')
    im = Image.open('F:/Chinese-ocr/chinese_ocr/test_images/1.jpg')
